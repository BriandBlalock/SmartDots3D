...
public class Optimizer : MonoBehaviour {
	...
	void Start () {
        ...
        experiment.Initialize("Ball Experiment", xmlConfig.DocumentElement, NUM_INPUTS, NUM_OUTPUTS);

        champFileSavePath = Application.persistentDataPath + string.Format("/{0}.champ.xml", "ball");
        popFileSavePath = Application.persistentDataPath + string.Format("/{0}.pop.xml", "ball");       
    ...
    {        
        Utility.DebugLog = true;
        Utility.Log("Starting SmartDot 3-D experiment");
